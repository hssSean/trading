      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 scroll-container space-y-3">
          ...
          <>
            ...
            <div className="bg-[#0F141A] border border-[#1B222B] rounded-md p-3 overflow-x-auto">
              ...
              {ingest.log.trades.length > 8 && (
                <p className="text-[#3A424E] text-[10px] mt-1.5 text-center">…共 {ingest.log.trades.length} 筆</p>
              )}
            </div>
        ...
        {step === 'result' && analyzing && (
          <div className="flex flex-col items-center justify-center py-20 gap-3">
            ...
            <p className="text-[#565E6B] text-xs">正在跑 t 檢定與 5000 次 Bootstrap 重抽…</p>
          </div>
        )}
            ...
            <>
              ...
              <div className="bg-[#0F141A] border border-[#1B222B] rounded-md p-4">
                ...
                <div className="mt-3 pt-3 border-t border-[#1B222B]">
                  ...
                  {oos.interpretation.map((s, i) => (
                    <p key={i} className="text-[#565E6B] text-[10px] leading-4 mb-1">{s}</p>
                  ))}
                </div>
              </div>
                  ...
                  <div className="space-y-2">
                    {v.redFlags.map((f, i) => (
                      <div key={i} className="flex gap-2">
                        ...
                        <p className="text-[#8A94A2] text-xs leading-5">{f.message}</p>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {result.followGuru && (
                <div className="bg-[#0F141A] border border-[#C99A2E]/30 rounded-md p-4">
                  ...
                  <p className="text-[#8A94A2] text-xs leading-5">{result.followGuru.message}</p>
                </div>
              )}
